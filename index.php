...
<main class="main" id="main">
	...
	<section class="section section-pd">
		<div class="wrap">
			...
			<a href="#header" class="to-video">
				<img src="<?php echo get_template_directory_uri() ?>/img/course.jpg" alt="">
	...
	<?php
		...
		//Вывожу блок ивентов в отдельный файл для удобства работы
			...
			<div class="row card-full-light-amount">
				<div class="col">
					<div class="card-full-light">
						...
						<img src="<?php echo get_template_directory_uri() ?>/img/card.jpg" alt="" class="cover-img">
					</div>
				</div>
				<div class="col">
					<div class="card-full-light">
	...
	<section class="section section-pd bg-light-grey t-center">
		<div class="wrap">
			...
			<ul class="slider partners-slider" id="partners">
				<li class="slider-item"><img src="<?php echo get_template_directory_uri() ?>/img/partners/hub.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri() ?>/img/partners/microsoft.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri() ?>/img/partners/atb.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri() ?>/img/partners/hub.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri() ?>/img/partners/microsoft.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri() ?>/img/partners/atb.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri() ?>/img/partners/hub.svg" alt=""></li>
